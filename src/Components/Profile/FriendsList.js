...
const FriendsList = ( props ) => {
    ...
    //sets the users array for mapping below
...
//the limitNum is dynamic (via props) for future use in seeing 'all' friends, which is accessible through the last link
